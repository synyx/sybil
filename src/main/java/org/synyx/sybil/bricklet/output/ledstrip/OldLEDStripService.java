...
@Service
public class OldLEDStripService implements BrickletService {

    private static final Logger LOG = LoggerFactory.getLogger(OldLEDStripService.class);
     ...
     */
    @Autowired
    public OldLEDStripService(OldBrickService brickService, LEDStripRepository ledStripRepository,
