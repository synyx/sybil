...
public class OLdLEDStripDomain implements DeviceDomain {
     ...
     */
    public OLdLEDStripDomain(String name, String uid, int length, BrickDomain brickDomain) {
    ...
    public boolean equals(Object o) {
        ...
        return areFieldsEqual((OLdLEDStripDomain) o);
    }


    private boolean areFieldsEqual(OLdLEDStripDomain o) {
